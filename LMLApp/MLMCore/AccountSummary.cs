...
namespace LMLApp
{
    class AccountSummary:CoreBase
    {
         #region Constructors

        public AccountSummary()
        {
            _ProcedureName = StoredProcedure.Name.Payments_tblCustomerFinancialAccounts;
        ...
        private IList<AccountSummary> _AccountSummary;
        ...
        public IList<AccountSummary> CustomerList
        {
            get { return _AccountSummary; }
            set { _AccountSummary = value; }
        }
